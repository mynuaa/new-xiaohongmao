...
include API_ROOT . '/src/classes/dingxiang/model/CtuRequest.php';
include API_ROOT . '/src/classes/dingxiang/model/CtuResponse.php';
include API_ROOT . '/src/classes/dingxiang/SignUtil.php';
